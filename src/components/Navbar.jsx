...
const Navbar = () => {
  return (
    <nav className="fixed w-full left-0 top-0 bg-[#fff] z-[99] kuda-shadow">
      <div className="flex justify-between items-center w-full max-w-[1500px] mx-0 my-auto pl-[60px] pr-[60px]">
        <div className="flex items-center">
          ...
          <ul className="ml-[15%] flex items-center">
            <li className="relative mr-[42px]">
              <p className="flex items-center text-[#40196d] text-[.875rem] font-bold cursor-pointer h-[40px]">
                Features
              </p>
            </li>
            <li className="relative mr-[42px]">
        ...
        <div className="flex items-center ml-[auto]">
          <a
            className="text-[.875rem] w-full max-w-full font-bold text-[#40196d]"
            href="https://app.kuda.com/"
          >
            Sign In
          </a>
          <a
            className="cursor-pointer bg-[#40196d] h-[65px] min-w-[136px] max-w[136px] ml-[40px] flex items-center justify-center leading-none p-[15px] text-[#fff] rounded-[10px] transition w-full left-0 top-0 m-2"
        ...
        <div className="relative mr-0 ml-[28px] h-[42px]">
            <div className="h-[40px] cursor-pointer flex items-center text-[#40196d]">
